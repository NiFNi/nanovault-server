/** Configuration **/
const nanoNodeUrl = `http://127.0.0.1:7076`; // Nano node RPC url
const nanoWorkNodeUrl = `http://127.0.0.1:7076`; // Nano work node RPC url
...
const redisCacheUrl = `127.0.0.1`; // Url to the redis server (If used)
